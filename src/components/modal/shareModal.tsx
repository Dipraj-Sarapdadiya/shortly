...
export const ShareModal: React.FC<ShareModalProps> = ({ isOpen, onClose, shortId }) => {
  ...
  return (
    <>
      <Modal title="Share your SnS Link" isOpen={isOpen} onClose={onClose}>
        <div className="grid grid-cols-4 gap-4 w-4/5 mx-auto">
          <Button
            variant="ghost"
            className="flex flex-col gap-y-2 h-auto w-auto"
            onClick={() =>
              window.open(
                new URL(
                  `https://wa.me/?text=Check%20out%20this%20link%20shortened%20with%20shortnshare.com%0D%0Ahttps%3A%2F%2F${window.location.host}/${shortId}`,
                ),
                "_blank",
                "noopener,noreferrer",
              )
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                new URL(`https://facebook.com/sharer.php?u=https%3A%2F%2F${window.location.host}/${shortId}`),
                "_blank",
                "noopener,noreferrer",
              )
            }>
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                new URL(
                  `https://twitter.com/intent/tweet?text=Check%20out%20this%20link%20shortened%20with%20shortnshare.com%0D%0Ahttps%3A%2F%2F${window.location.host}/${shortId}`,
                ),
                "_blank",
                "noopener,noreferrer",
              )
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                new URL(
                  `https://www.linkedin.com/feed/?shareActive=true&text=Check%20out%20this%20link%20shortened%20with%20shortnshare.com%0D%0Ahttps%3A%2F%2F${window.location.host}/${shortId}`,
                ),
                "_blank",
                "noopener,noreferrer",
              )
          ...
          <Button
            variant="ghost"
            className="flex flex-col gap-y-2 h-auto w-auto"
            onClick={() => window.open(new URL(`https://www.instagram.com/`), "_blank", "noopener,noreferrer")}>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
              <path
                fill="#304ffe"
          ...
          <Button
            variant="ghost"
            className="flex flex-col gap-y-2 h-auto w-auto"
            onClick={() => window.open(new URL(`https://www.messenger.com/`), "_blank", "noopener,noreferrer")}>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
              <path
                fill="#448AFF"
                d="M24,4C13.5,4,5,12.1,5,22c0,5.2,2.3,9.8,6,13.1V44l7.8-4.7c1.6,0.4,3.4,0.7,5.2,0.7c10.5,0,19-8.1,19-18C43,12.1,34.5,4,24,4z"></path>
          ...
          <Button
            variant="ghost"
            className="flex flex-col gap-y-2 h-auto w-auto"
            onClick={() => window.open(new URL(`https://www.youtube.com/`), "_blank", "noopener,noreferrer")}>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
              <path
                fill="#FF3D00"
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                new URL(
                  `mailto:?subject=Check%20out%20my%20Shortnshare%20Link!&body=Check%20out%20this%20link%20shortened%20with%20shortnshare.com%0D%0Ahttps%3A%2F%2F${window.location.host}/${shortId}`,
                ),
                "_blank",
                "noopener,noreferrer",
              )
            ...
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
              <path
                fill="#e0e0e0"
                d="M5.5,40.5h37c1.933,0,3.5-1.567,3.5-3.5V11c0-1.933-1.567-3.5-3.5-3.5h-37C3.567,7.5,2,9.067,2,11v26C2,38.933,3.567,40.5,5.5,40.5z"></path>
              <path
                fill="#d9d9d9"
                d="M26,40.5h16.5c1.933,0,3.5-1.567,3.5-3.5V11c0-1.933-1.567-3.5-3.5-3.5h-37C3.567,7.5,2,9.067,2,11L26,40.5z"></path>
              ...
              <path
                fill="#ca3737"
                d="M42.5,9.5h-37C3.567,9.5,2,9.067,2,11v26c0,1.933,1.567,3.5,3.5,3.5H7V12h34v28.5h1.5c1.933,0,3.5-1.567,3.5-3.5V11C46,9.067,44.433,9.5,42.5,9.5z"></path>
              <path
                fill="#f5f5f5"
                d="M42.5,7.5H24H5.5C3.567,7.5,2,9.036,2,11c0,1.206,1.518,2.258,1.518,2.258L24,27.756l20.482-14.497c0,0,1.518-1.053,1.518-2.258C46,9.036,44.433,7.5,42.5,7.5z"></path>
              <path
                fill="#e84f4b"
                d="M43.246,7.582L24,21L4.754,7.582C3.18,7.919,2,9.297,2,11c0,1.206,1.518,2.258,1.518,2.258L24,27.756l20.482-14.497c0,0,1.518-1.053,1.518-2.258C46,9.297,44.82,7.919,43.246,7.582z"></path>
            </svg>
            <Separator />
        ...
        <div className="flex justify-between items-center mt-3 gap-2">
          <text className="flex justify-between w-full items-center border border-input h-9 rounded-md pl-2 bg-accent text-accent-foreground">
          ...
          <Button
            ...
            onClick={() => {
              navigator.clipboard.writeText(`${window.location.host}/${shortId}`);
              toast({
                description: "Copied successfully!",
              });
            }}>
            <Copy className="flex-1 h-4 w-4 mr-2 hover:text-accent-foreground" />
            Copy
          </Button>
        </div>
      </Modal>
