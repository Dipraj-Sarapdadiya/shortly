    ...
    <div className="pt-20 flex flex-col gap-y-4">
      <div className="title font-semibold flex flex-col justify-center items-center gap-y-4">
        ...
        <p className="text-lg text-center text-primary-foreground-500">
          Discover a unified platform to create seamless brand interactions, manage links and QR Codes, and engage
      ...
      <div className="offer-card flex lg:flex-row flex-col items-center justify-center gap-x-16  gap-y-8 pt-8">
        <div className="card-one w-full lg:w-2/6 h-auto rounded-lg border bg-card text-card-foreground shadow-sm flex flex-col px-6">
          <div className="card-title flex gap-x-2 pt-5 justify-center text-xl font-semibold">
            <Link2 />
            <h3>URL Shortener</h3>
          </div>
          <p className="text-center text-sm pt-2">
            An all-in-one solution designed to amplify every interaction between your content and your audience.
          </p>

          <div className="card-feature flex flex-col py-5">
            <h4 className="text-sm font-semibold">Explore the Top Link Management Features:</h4>
        ...
        <div className="card-two w-full lg:w-2/6 h-auto rounded-lg border bg-card text-card-foreground shadow-sm flex flex-col px-6">
          <div className="card-title flex gap-x-2 pt-5 justify-center text-xl font-semibold">
            <QrCode />
            <h3>QR Codes</h3>
          </div>
